...
const styles = {
  ...
  btnEstado:       { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: '44px', border: 'none', color: '#fff', borderRadius: '6px', padding: '5px 12px', cursor: 'pointer', fontSize: '11px', fontWeight: '600' },
  btnEditar:       { display: 'inline-flex', alignItems: 'center', justifyContent: 'center', minHeight: '44px', background: 'transparent', border: '1px solid var(--gl-dispatch)', color: 'var(--gl-dispatch)', borderRadius: '5px', padding: '4px 14px', cursor: 'pointer', fontSize: '11px' },
